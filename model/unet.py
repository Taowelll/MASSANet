...
class Unet(nn.Module):
    def __init__(self, num_classes=21):
        ...
        # Upsampling blocks with optional channel or spatial attention.
        self.up_concat4 = unetUp(512, 256, 256, upsize=256, att_type='channel')
        # (256, 16, 16) -> (256, 32, 32), concatenate with skip feature to get (512, 32, 32).
        self.up_concat3 = unetUp(512, 256, 128, upsize=256, att_type='channel')
        # (256, 32, 32) -> (256, 64, 64), concatenate with skip feature to get (512, 64, 64).
        self.up_concat2 = unetUp(256, 128, 128, upsize=128, att_type='spatial')
        # (128, 64, 64) -> (128, 128, 128), concatenate with skip feature to get (256, 128, 128).
        self.up_concat1 = unetUp(256, 128, 64, upsize=128, att_type='spatial')
        # (128, 128, 128) -> (128, 256, 256), concatenate with skip feature to get (256, 256, 256).
        self.up_concat0 = unetUp(128, 64, 64, upsize=64, att_type='spatial')
        # (64, 256, 256) -> (64, 512, 512), concatenate with skip feature to get (128, 512, 512).
    ...
    def forward(self, inputs):
        ...
        feat5 = feat5.transpose(1, 2).view(-1, 512, int(height / 32), int(width / 32))
...
# example = torch.randn(1, 3, 800, 800)
